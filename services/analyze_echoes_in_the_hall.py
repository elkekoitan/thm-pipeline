...
y, sr = librosa.load('/home/ubuntu/muzik/echoes_in_the_hall.mp3', sr=None)
duration = len(y) / sr
...
with open('/home/ubuntu/muzik/echoes_in_the_hall_rhythm.json', 'w') as f:
    json.dump(out, f)
print("Saved echoes_in_the_hall_rhythm.json")
