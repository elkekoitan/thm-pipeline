...
y, sr = librosa.load('/home/ubuntu/muzik/midnight_train.mp3', sr=None)
duration = len(y) / sr
...
with open('/home/ubuntu/muzik/midnight_train_rhythm.json', 'w') as f:
    json.dump(out, f)
print("Saved midnight_train_rhythm.json")
