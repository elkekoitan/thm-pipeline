...
y, sr = librosa.load('/home/ubuntu/muzik/paper_walls.mp3', sr=None)
duration = len(y) / sr
...
with open('/home/ubuntu/muzik/paper_walls_rhythm.json', 'w') as f:
    json.dump(out, f)
print("Saved paper_walls_rhythm.json")
